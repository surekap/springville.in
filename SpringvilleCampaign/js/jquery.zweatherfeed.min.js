...
var html='<div class="weatherItem '+row+'"';if(options.image)html+=' style="background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/'+feed.item.condition.code+daynight+'.png); background-repeat: no-repeat;"';html+='>';html+='';html+='<div class="weatherTemp">'+feed.item.condition.temp+'&deg; <sup>c</sup></div>';html+='';if(options.highlow)html+='';if(options.wind)html+='';if(row=='odd'){row='even';}else{row='odd';}
